...
import { ListEstabilizadorController } from "./controllers/status_categorias/estabilizador/ListEstabilizadorController";
...
router.get('/list/tipo/equipamento', isAuthenticated, new ListtipodeEquipamentoController().handle);
